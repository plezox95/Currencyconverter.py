...
#buttons
button1 = Button(root,text="CONVERT", font=FONT, bg="yellow", fg="black", activeforeground="pink",activebackground="black")
button1.place(relx=0.16,rely=0.4,relwidth=0.15,relheight=0.07)

button2 = Button(root, text = "CLEAR", font = FONT,  bg = "yellow", fg = "black", activeforeground = "pink", activebackground = "black")
button2.place(relx = 0.35,rely = 0.4,relwidth = 0.13, relheight = 0.07)

button3 = Button(root, text = "REFERENCE", font = FONT,  bg = "yellow", fg = "black", activeforeground = "pink", activebackground = "black")
button3.place(relx = 0.52, rely = 0.4, relwidth = 0.15, relheight = 0.07)

button4= Button(root, text = "EXIT", font = FONT,  bg = "yellow", fg = "black", activeforeground = "pink", activebackground = "black")
